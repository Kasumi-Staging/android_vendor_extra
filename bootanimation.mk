...
# Bootanimation
ifeq ($(filter 1080,$(TARGET_BOOT_ANIMATION_RES)),)
...
PRODUCT_COPY_FILES += \
    vendor/extra/bootanimation/bootanimation-$(TARGET_BOOT_ANIMATION_RES).zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
